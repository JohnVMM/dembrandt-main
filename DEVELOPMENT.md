...
│   ├── bundle-extractor.js       # Multi-page bundle orchestration
│   ├── discovery.js              # Internal page discovery and ranking
│   ├── security.js               # URL validation, SSRF, execution limits
│   ├── schemas.js                # Output contract validation helpers
│   └── display.js                # Terminal output formatting
├── tests/                        # Unit + contract tests (node:test)
